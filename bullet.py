...
class Bullet(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.bullet_up = pygame.image.load("image/bullet_up.png", "r")
        self.bullet_down = pygame.image.load("image/bullet_down.png", "r")
        self.bullet_left = pygame.image.load("image/bullet_left.png", "r")
        self.bullet_right = pygame.image.load("image/bullet_right.png", "r")
